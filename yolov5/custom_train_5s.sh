...
python -m torch.distributed.run --nproc_per_node 4 train.py --img 1024 --batch 8 --epochs 70 --data data/VisDrone.yaml --cfg ./models/yolov5s.yaml --weights yolov5s.pt  --name yolov5s_visdrone  --cache --device 0,1,2,3
